...
final class Version20241129184535 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Initial entities created and linked';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE conference (id INT NOT NULL, city VARCHAR(25) NOT NULL, year VARCHAR(4) NOT NULL, is_international BOOLEAN NOT NULL, PRIMARY KEY(id))');
